     ...
     <div class="col-md-12">
      <div class="card">
       <div class="card-header">
        ...
        <a href="{{ route('admin.category.create') }}" class="btn btn-info float-right">New</a>
       </div>
       <!-- /.card-header -->
       <div class="card-body">
        <table class="table table-bordered">
         ...
         <tbody>
          <tr>
           ...
           <td><a href="{{ route('admin.category.edit', ['category' => 1]) }}" class="btn btn-warning">Update</a></td>
          </tr>
         </tbody>
        </table>
       </div>
