     ...
     <div class="col-md-12">
      <div class="card">
       <div class="card-header">
        ...
        <a href="{{ route('admin.category.index') }}" class="btn btn-info float-right">New</a>
       </div>
       <!-- /.card-header -->
       <div class="card-body">
        <table class="table table-bordered" id="categories-datatable">
         <thead>
          <tr>
 ...
 <script>
  $(function() {
   $('#categories-datatable').DataTable({
    processing: true,
    serverSide: true,
    ajax: '{{ url('admin/category/get-data') }}',
    columns: [{
      data: 'id',
      name: 'id'
     },
