...
<body data-app-data="{&quot;locale&quot;:&quot;en&quot;,&quot;csrf-token&quot;:&quot;z5upfwm009jctnyp&quot;,&quot;userId&quot;:0}">
    ...
    <noscript>
        <div><img src="{{asset('https://mc.yandex.ru/watch/36956765?ut=noindex')}}" style="position:absolute; left:-9999px;" alt="" /></div>
    </noscript>
    <div class="wrapper">
                        ...
                        <div class="container">
                            <div class="cd-forward">
                                <div class="counter-list counter-list-circles">
                                    ...
                                    <a href="{{ route('subcatpage', $subcat->slug) }}" class="counter-item {{ $subcat->name === $subcategory->name ? 'active' : '' }}" style="width: 110px; height: 110px;">
                                        <div class="inside">
